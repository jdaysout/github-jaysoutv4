    ...
    >
      <div className="flex flex-col gap-8">
        <div className="text-center">
          ...
          <h3 className="text-3xl font-bold text-white mb-4">Hi, I'm J :)</h3>
          <p className="text-xl text-primary mb-2">
            Your Guide to AI Innovation
          </p>
          <p className="text-text-secondary max-w-2xl mx-auto">
            A Sales & Network Strategist passionate about exploring new
            solutions. With experience spanning communications, real estate,
            business development, and the music industry, I bring a fresh,
